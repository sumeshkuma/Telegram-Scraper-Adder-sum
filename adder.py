...
print (cy+"https://youtu.be/aW2oO7pfGK8")

print (re+"NOTE :")
print ("1. Telegram only allow to add 1000 members in group by one user.")
print ("2. You can Use multiple Telegram accounts for add more members.")
print ("3. Add only 1000 members in group each time otherwise you will get flood error.")
print ("4. Then wait for 20-40 miniute then add members again.")
...
for user in users:
    ...
    try:
        ...
        print("Waiting for 80-200 Seconds...")
